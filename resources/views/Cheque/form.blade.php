...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5">
      ...
      <h1 class="text-center mb-4">Cheque Form</h1>
      <form action="{{route('cheque.upload')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="figure" name="figure">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
