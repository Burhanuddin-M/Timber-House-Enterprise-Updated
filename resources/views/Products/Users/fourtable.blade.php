                                ...
                                <tbody>
                                    @foreach ($fourProducts as $item)
                                        <tr>
                                            ...
                                            <!-- Add this inside the <tr> loop for each cost price -->
                                            <td class="text-center cost-price" data-cost="{{ $item->one_price_cost }}">
                                           ...
                                           <!-- Add this inside the <tr> loop for each cost price -->
                                            <td class="text-center cost-price" data-cost="{{ $item->two_price_cost }}">
                                                <button class="toggle-cost-btn"><i class="fas fa-eye"></i></button>
                                            </td>
                                            ...
                                            <!-- Add this inside the <tr> loop for each cost price -->
                                                <td class="text-center cost-price" data-cost="{{ $item->three_price_cost }}">
                                                    <button class="toggle-cost-btn"><i class="fas fa-eye"></i></button>
                                                </td>
