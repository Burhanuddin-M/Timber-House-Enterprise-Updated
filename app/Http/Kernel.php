...
use App\Http\Middleware\AttendanceChecker;
use App\Http\Middleware\CftChecker;
use App\Http\Middleware\DocumentChecker;
...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'session_checker' => SessionChecker::class,
        'attendance_checker' => AttendanceChecker::class,
        'cft_checker' => CftChecker::class,
